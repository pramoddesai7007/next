...
const BankNameList = () => {
  ...
  useEffect(() => {
    const fetchBankNames = async () => {
      try {
        const response = await axios.get('http://ec2-13-127-129-242.ap-south-1.compute.amazonaws.com:5000/api/bankName/bankNames');
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.patch(`http://ec2-13-127-129-242.ap-south-1.compute.amazonaws.com:5000/api/bankName/bankNames/${selectedBankName._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      await axios.delete(`http://ec2-13-127-129-242.ap-south-1.compute.amazonaws.com:5000/api/bankName/bankNames/${selectedBankName._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('http://ec2-13-127-129-242.ap-south-1.compute.amazonaws.com:5000/api/bankName/bankNames', { bankName: newBankName });
